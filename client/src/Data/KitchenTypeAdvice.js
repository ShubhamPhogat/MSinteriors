const KitchenTypeAdvicePeninsula = [
  {
    ...
    icon: "path/to/triangle-icon.png",
    type: "peninsula",
    topic: "advice",
  },
  {
    ...
    icon: "path/to/appliances-icon.png",
    type: "peninsula",
    topic: "advice",
  },
  {
  ...
  },
  {
    ...
    icon: "path/to/peninsula-icon.png",
    type: "peninsula",
    topic: "advice",
  },
  {
  ...
  },
  {
    ...
    icon: "path/to/furniture-icon.png",
    type: "peninsula",
  },
];
